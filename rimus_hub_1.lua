...
local ThunderImageUI = Instance.new("ImageLabel")
        ...
        ThunderImageUI.Image = "http://www.roblox.com/asset/?id=18737910294"
...
Logo.Image = "rbxassetid://18737910294"
...
Notification:Notify(
   ...
   {Image = "http://www.roblox.com/asset/?id=17094709022", ImageColor = Color3.fromRGB(255, 84, 84), Callback = function(State) print(tostring(State)) end}
)
                    else
                        if World2 then
