local ZueszYTB = loadstring(game:HttpGet("https://raw.githubusercontent.com/ahmadsgamer2/Speed-Hub-X/main/Library.lua"))()
...
local Window = ZueszYTB:CreateWindow({
Title = "Tên YTB | ".._G.Version,
...
local Tabs = {
Main = Window:AddTab({ Title = "Chủ yếu", Icon = "home" }),wait(1),
Item = Window:AddTab({ Title = "Mục", Icon = "swords" }),wait(),
Stats = Window:AddTab({ Title = "Thống kê", Icon = "plus-circle" }),wait(1),
Shop = Window:AddTab({ Title = "Cửa hàng", Icon = "shopping-cart" }),wait(1),
Island = Window:AddTab({ Title = "Hòn đảo", Icon = "palmtree" }),wait(1),
Raid = Window:AddTab({ Title = "Ngục tối", Icon = "sword" }),wait(1),
RaceV4 = Window:AddTab({ Title = "Tộc v4", Icon = "chevrons-right" }),wait(1),
Fruit = Window:AddTab({ Title = "Hoa quả", Icon = "apple" }),wait(1),
ESP = Window:AddTab({ Title = "ESP", Icon = "mountain-snow" }),wait(1),
Misc = Window:AddTab({ Title = "Điều khoản khác", Icon = "list-plus" }),wait(1),
Visual = Window:AddTab({ Title = "Thị giác", Icon = "scan-face" }),wait(1),
Settings = Window:AddTab({ Title = "Cài đặt", Icon = "settings" }),wait(1),
}

if game.CoreGui:FindFirstChild("ZueszYTBOpenClose") then
game.CoreGui:FindFirstChild("ZueszYTBOpenClose"):Destroy()
end
...
local ScreenGui = Instance.new("ScreenGui")
ScreenGui.Name = "ZueszYTBOpenClose"
...
ImageButton.Image = "rbxassetid://16275269532"
...
local Options = ZueszYTB.Options
...
if readfile and writefile and isfile and isfolder then
    if not isfolder("ZueszYTB_V2") then
        makefolder("ZueszYTB_V2")
    end
    if not isfolder("ZueszYTB_V2/Blox Fruits/") then
        makefolder("ZueszYTB_V2/Blox Fruits/")
    end
    if not isfile("ZueszYTB_V2/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
        writefile("ZueszYTB_V2/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
    else
        local Decode = game:GetService("HttpService"):JSONDecode(readfile("ZueszYTB_V2/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
...
if readfile and writefile and isfile and isfolder then
    if not isfile("ZueszYTB_V2/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
        ...
        writefile("ZueszYTB_V2/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
    end
else
    return warn("Status: error")
end
...
local TurnFastAttack = Tabs.Main:AddToggle("FastAttack_Toggle", {Title = "Tấn công nhanh", Default = true })
...
local EnableFarm = Tabs.Main:AddToggle("EnableFarm_Toggle", {Title = "Tự động cày cấp độ", Default = false })
...
local EnableNeareastFarm = Tabs.Main:AddToggle("EnableFarmNeareast_Toggle", {Title = "Giết quái xung quanh", Default = false })
...
local ChestFarmGood = Tabs.Main:AddToggle("ChestFarmGood_Toggle", {Title = "Nhặt rương [Good]", Default = false })

local ChestFarmTween = Tabs.Main:AddToggle("ChestFarmTween_Toggle", {Title = "Nhặt rương [Bay]", Default = false })
...
local AutoCastleRaid = Tabs.Main:AddToggle("AutoCastleRaid_Toggle", {Title = "Đột kích lâu đài tự động", Default = false })
...
local AutoFarmFruitMastery1 = Tabs.Main:AddToggle("AutoFarmFruitMaster_Toggle", {Title = "Cày Cấp độ trái ác quỷ", Default = false })
...
local AutoFarmGunMastery1 = Tabs.Main:AddToggle("AutoFarmGunMaster_Toggle", {Title = "Cày cấp độ súng", Default = false })
...
local SkillZ = Tabs.Main:AddToggle("SkillZ_Toggle", {Title = "kĩ năng Z", Default = true })
...
local SkillX = Tabs.Main:AddToggle("SkillX_Toggle", {Title = "kĩ năng X", Default = false })
...
local SkillC = Tabs.Main:AddToggle("SkillC_Toggle", {Title = "kĩ năng C", Default = false })
...
local SkillV = Tabs.Main:AddToggle("SkillV_Toggle", {Title = "kĩ năng V", Default = false })
...
local SkillF = Tabs.Main:AddToggle("SkillF_Toggle", {Title = "kĩ năng F", Default = false })
...
local AutoFarmBoss = Tabs.Main:AddToggle("AutoFarmBoss_Toggle", {Title = "Đánh Boss", Default = false })
...
local AutoFarmBoss = Tabs.Main:AddToggle("AutoFarmBoss_Toggle", {Title = "Đánh Boss [Nhận nhiệm vụ]", Default = false })
Options.AutoFarmBoss_Toggle:SetValue(false)
...
local AutoFarmBossAll = Tabs.Main:AddToggle("AutoFarmBossAll_Toggle", {Title = "Đánh Boss [Tất cả]", Default = false })
...
local AutoMaterialToggle = Tabs.Main:AddToggle("AutoMaterial_Toggle", {Title = "Cày Nguyên liệu", Default = false })
...
if World1 then
Tabs.Main:AddParagraph({
    Title = "Tình trạng: Thế giới 1",
    Content = ""
})

local AutoNewWorldToggle = Tabs.Main:AddToggle("AutoNewWorld_Toggle", {Title = "Ô tô thế giới mới", Default = false })
...
if World2 then
Tabs.Main:AddParagraph({
    Title = "Trạng thái: Thế giới 2",
    Content = ""
})

local AutoNewWorld3Toggle = Tabs.Main:AddToggle("AutoNewWorld3_Toggle", {Title = "Ô tô thế giới mới thứ ba", Default = false })
...
Title = "Saber | Từ đầu tiên",
Content = ""
})

local AutoFarmSaberToggle = Tabs.Item:AddToggle("AutoSaber_Toggle", {Title = "Lấy Saber", Default = false })
...
local AutoFarmPoleToggle = Tabs.Item:AddToggle("AutoPole_Toggle", {Title = "Lấy Pole", Default = false })
...
local HallowToggle = Tabs.Item:AddToggle("Hallow_Toggle", {Title = "Lưỡi hái thần thánh", Default = false })
...
local AutoFarmFactoryToggle = Tabs.Item:AddToggle("AutoFactory_Toggle", {Title = "Nhà máy | Thế giới thứ hai", Default = false })
...
Tabs.Item:AddParagraph({
Title = "Vật chất kì dị",
Content = ""
})

local AutoFarmEctoplasmToggle = Tabs.Item:AddToggle("AutoEctoplasm_Toggle", {Title = "Cày vật chất kì dị", Default = false })
...
local AutoSeaBeastToggle = Tabs.Item:AddToggle("AutoSeaBeast_Toggle", {Title = "Đánh Quái vật biển", Default = false })
...
Tabs.Item:AddParagraph({
Title = "Áo khoác tối màu",
Content = ""
})

local AutoFarmDarkToggle = Tabs.Item:AddToggle("AutoDark_Toggle", {Title = "Lấy Áo khoác tối màu", Default = false })
...
Tabs.Item:AddParagraph({
Title = "Kính Thiên Nga",
Content = ""
})

local AutoFarmSwanToggle = Tabs.Item:AddToggle("AutoSwan_Toggle", {Title = "Lấy Kính Thiên Nga", Default = false })
...
local AutoFarmSwanHopToggle = Tabs.Item:AddToggle("AutoSwanHop_Toggle", {Title = "Lấy Kính thiên nga tự động [Hop]", Default = false })
...
local AutoKillEventToggle = Tabs.Item:AddToggle("AutoKillEvent_Toggle", {Title = "Tự động tiêu diệt [Sự kiện]", Default = false })
...
local AutoKillTerrorsharkToggle = Tabs.Item:AddToggle("AutoKillTerrorshark_Toggle", {Title = "Tự động tiêu diệt cá mập khủng bố", Default = false })
...
local AutoKillPiranhaToggle = Tabs.Item:AddToggle("AutoKillPiranha_Toggle", {Title = "Tự Động Giết Piranha", Default = false })
...
local AutoKillSharkToggle = Tabs.Item:AddToggle("AutoKillShark_Toggle", {Title = "Tự động tiêu diệt cá mập", Default = false })
...
local AutoKillFishCrewMemberToggle = Tabs.Item:AddToggle("AutoKillFishCrewMember_Toggle", {Title = "Thành viên phi hành đoàn giết cá tự động", Default = false })
...
local SpeedBoatToggle = Tabs.Item:AddToggle("SpeedBoat_Toggle", {Title = "Thuyền cao tốc", Default = false })
...
local No_clipRockBoatToggle = Tabs.Item:AddToggle("No_clipRockBoat_Toggle", {Title = "Đi xuyên đá", Default = false })
...
local AutoFarmRainbowToggle = Tabs.Item:AddToggle("AutoRainbow_Toggle", {Title = "Lấy Haki cầu vồng tự động", Default = false })
...
local AutoFarmRainbowHopToggle = Tabs.Item:AddToggle("AutoRainbowHop_Toggle", {Title = "Lấy Tự động cầu vồng Haki [Hop]", Default = false })
...
if W2 then
local AutoFarmEvoV2Toggle = Tabs.Item:AddToggle("AutoEvoV2_Toggle", {Title = "Cuộc đua tự động V2", Default = false })
...
if W2 then
local AutoFarmBartiloToggle = Tabs.Item:AddToggle("AutoBartilo_Toggle", {Title = "Nhiệm vụ Bartilo tự động", Default = false })
...
if W2 then
local AutoFarmRengokuToggle = Tabs.Item:AddToggle("AutoRengoku_Toggle", {Title = "Lấy Kiếm Rengoku tự động", Default = false })
...
if W2 then
local AutoLegendarySwordToggle = Tabs.Item:AddToggle("AutoLegendarySword_Toggle", {Title = "Tự động mua thanh kiếm huyền thoại", Default = false })
...
local AutoEnchancementToggle = Tabs.Item:AddToggle("AutoEnchancement_Toggle", {Title = "Nâng cao mua tự động", Default = false })
...
if W3 then	
local AutoMusketeerToggle = Tabs.Item:AddToggle("AutoMusketeer_Toggle", {Title = "Mũ lính ngự lâm tự động", Default = false })
...
if W3 then
local AutoFarmHolyToggle = Tabs.Item:AddToggle("AutoHoly_Toggle", {Title = "Ngọn đuốc thánh tự động", Default = false })
...
if W3 then
local YamaSwordToggle = Tabs.Item:AddToggle("YamaSword_Toggle", {Title = "Lấy Yama", Default = false })
...
local AutoFarmObservation = Tabs.Item:AddToggle("AutoFarmObservation_Toggle", {Title = "Haki quan sát trang trại ô tô", Default = false })
...
local AutoFarmObservationHop = Tabs.Item:AddToggle("AutoFarmObservationHop_Toggle", {Title = "Haki quan sát trang trại tự động [Hop]", Default = false })
...
local AutoFarmrip_indra = Tabs.Item:AddToggle("AutoFarmrip_indra_Toggle", {Title = "Giết Rip_Indra [Boss]", Default = false })
...
local AutoFarmKatakuri = Tabs.Item:AddToggle("AutoFarmKatakuri_Toggle", {Title = "Đánh tư lệnh bột", Default = false })
...
local AutoFarmBone = Tabs.Item:AddToggle("AutoFarmBone_Toggle", {Title = "Cày Xương", Default = false })
...
local AutoRandomBone = Tabs.Item:AddToggle("AutoRandomBone_Toggle", {Title = "trao đổi xương", Default = false })
...
local AutoEliteHunterToggle = Tabs.Item:AddToggle("AutoEliteHunter_Toggle", {Title = "Giết thợ săn thần bí", Default = false })
...
local AutoEliteHunterHopToggle = Tabs.Item:AddToggle("AutoEliteHunterHop_Toggle", {Title = "Giết thợ săn thần bí [Hop]", Default = false })
...
local EanbleStatsToggle = Tabs.Stats:AddToggle("EanbleStats_Toggle", {Title = "Bật thống kê", Default = false })
...
local EanbleStatsKaitunToggle = Tabs.Stats:AddToggle("EanbleStatsKaitun_Toggle", {Title = "Bật thống kê tự động", Default = false })
...
local TpToIslandToggle = Tabs.Island:AddToggle("TpToIsland_Toggle", {Title = "Bay đến đảo", Default = false })
...
Tabs.Island:AddButton({
Title = "bay đến người bán trái ác quỷ nâng cấp",
Description = "",
Callback = function()
...
Tabs.Island:AddButton({
Title = "bay đến người bán haki màu",
Description = "",
Callback = function()
...
local MirageTpToggle = Tabs.Island:AddToggle("MirageTp_Toggle", {Title = "Bay đến đảo bí ẩn", Default = false })
...
local GearToggle = Tabs.Island:AddToggle("GearTp_Toggle", {Title = "bay đến bánh răng", Default = false })
...
local GearBToggle = Tabs.Island:AddToggle("GearBTp_Toggle", {Title = "bay đến bánh răng xanh", Default = false })
...
if game.Workspace._WorldOrigin.Locations:FindFirstChild('Kitsune Island') then
    StatusKitsune:SetDesc("Đảo Kitsune : Có")
else
    StatusKitsune:SetDesc("Đảo Kitsune : Không có")
 end
end
...
local KitsuneToggle = Tabs.Island:AddToggle("KitsuneTp_Toggle", {Title = "bay đến Đảo Kitsune", Default = false })
...
local KitsuneShrineToggle = Tabs.Island:AddToggle("KitsuneShrineTp_Toggle", {Title = "bay đến đền thờ", Default = false })
...
local AzureToggle = Tabs.Island:AddToggle("Azure_Toggle", {Title = "Nhặt hồn lửa", Default = false })
...
local ChipsToggle = Tabs.Raid:AddToggle("Chips_Toggle", {Title = "mua Chips", Default = false })
...
local RaidToggle = Tabs.Raid:AddToggle("Raid_Toggle", {Title = "Bắt đầu tập tích", Default = false })
...
local KillAuraToggle = Tabs.Raid:AddToggle("KillAura_Toggle", {Title = "Giết tất cả quái xung quanh", Default = false })
...
local NextIslandToggle = Tabs.Raid:AddToggle("NextIsland_Toggle", {Title = "Bay qua đảo mới", Default = false })
...
local AwakenedToggle = Tabs.Raid:AddToggle("Awakened_Toggle", {Title = "Thức tỉnh trái ác quỷ", Default = false })
...
local LawChipsToggle = Tabs.Raid:AddToggle("LawChips_Toggle", {Title = "mua chip tập kích law", Default = false })
...
local LawRaidToggle = Tabs.Raid:AddToggle("LawRaid_Toggle", {Title = "Bắt đầu tập kích law", Default = false })
...
local KillLawRaidToggle = Tabs.Raid:AddToggle("KillLaw_Toggle", {Title = "Giết law", Default = false })
...
local LockMoonToggle = Tabs.RaceV4:AddToggle("LockMoon_Toggle", {Title = "nhìn theo mặt trăng", Default = false })
...
Tabs.RaceV4:AddButton({
Title = "Bay đến đền thờ của thời gian",
Description = "",
Callback = function()
...
Tabs.RaceV4:AddButton({
Title = "Bay đến cửa tộc thiên thần",
Description = "",
Callback = function()
...
Tabs.RaceV4:AddButton({
Title = "hoàn thành thử thách tộc thiên thần",
Description = "",
Callback = function()
...
Tabs.RaceV4:AddButton({
Title = "hoàn thành thử thách tộc thỏ",
Description = "",
Callback = function()
...
Tabs.RaceV4:AddButton({
Title = "hoàn thành thử thách tộc người máy",
Description = "",
Callback = function()
...
Title = "chọn trái ác quỷ ngắm tới",
Values = FruitList,
Multi = false,
Default = 1,
})
...
local SniperFruitToggle = Tabs.Fruit:AddToggle("SniperFruit_Toggle", {Title = "mua trái ác quỷ ngắm tới", Default = false })
...
local EatFruitToggle = Tabs.Fruit:AddToggle("EatFruit_Toggle", {Title = "Ăn trái cây", Default = false })
...
local GetInventoryFruitToggle = Tabs.Fruit:AddToggle("GetInventoryFruit_Toggle", {Title = "Bỏ trái cây vào rương", Default = false })
...
local Random_AutoToggle = Tabs.Fruit:AddToggle("Random_Auto_Toggle", {Title = "trao đổi trái cây", Default = false })
...
local AutoStoreToggle = Tabs.Fruit:AddToggle("AutoStoreFruit_Toggle", {Title = "Cất trái cây", Default = false })
...
local ESPPlrToggle = Tabs.ESP:AddToggle("ESPPlr_Toggle", {Title = "định vị người chơi", Default = false })
...
local ESPChestToggle = Tabs.ESP:AddToggle("ESPChest_Toggle", {Title = "định vị rương", Default = false })
...
local ESPFruitDToggle = Tabs.ESP:AddToggle("ESPFruitD_Toggle", {Title = "định vị trái ác quỷ", Default = false })
...
local ESPFlowerDToggle = Tabs.ESP:AddToggle("ESPFlower_Toggle", {Title = "định vị hoa", Default = false })
...
local ESPIslandToggle = Tabs.ESP:AddToggle("ESPIsland_Toggle", {Title = "định vị đảo", Default = false })
...
local WalkOnWaterToggle = Tabs.Misc:AddToggle("WalkOnWater_Toggle", {Title = "Đi trên nước", Default = true })
...
InfAbility()
SkyJumpNoCoolDown()
local infinityAbilityToggle = Tabs.Misc:AddToggle("infinityAbility_Toggle", {Title = "Vô hạng kĩ năng", Default = false })
...
local NoDashCooldownToggle = Tabs.Misc:AddToggle("NoDashCooldown_Toggle", {Title = "lướt không bao giờ ngừng", Default = false })
...
local infGeppoToggle = Tabs.Misc:AddToggle("infGeppo_Toggle", {Title = "nhảy không bao giờ ngừng", Default = false })
...
local infEnergyToggle = Tabs.Misc:AddToggle("infEnergy_Toggle", {Title = "vô hạn năng lượng", Default = false })
...
local BypassACToggle = Tabs.Settings:AddToggle("BypassAC_Toggle", {Title = "Chóng ban", Default = true })
...
local AutoHakiToggle = Tabs.Settings:AddToggle("AutoHaki_Toggle", {Title = "Bật haki vũ trang", Default = true })
...
local AutoKenToggle = Tabs.Settings:AddToggle("AutoKen_Toggle", {Title = "Bật haki quan sát", Default = false })
...
local BringMobToggle = Tabs.Settings:AddToggle("BringMob_Toggle", {Title = "Gom quái", Default = true })
...
local RemoveDamageToggle = Tabs.Settings:AddToggle("RemoveDamage_Toggle", {Title = "xoá dố damage", Default = false })
...
local RemoveNotifyToggle = Tabs.Settings:AddToggle("RemoveNotify_Toggle", {Title = "xoá thông báo", Default = false })
...
local WhiteToggle = Tabs.Settings:AddToggle("White_Toggle", {Title = "Màn hình treo", Default = false })
