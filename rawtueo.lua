...
local Window = Fluent:CreateWindow({
    local Logo = 1772974920
    Title = "AnDepZai Hub",
    SubTitle = "Anh Yeu Em ma",
    TabWidth = 100,
...
local Tabs = {
    An = Window:AddTab({ Title = "General", Icon = "" }),
    Dep = Window:AddTab({ Title = "Sub Farming", Icon = "" }), 
    Zai = Window:AddTab({ Title = "Stack Farming", Icon = "" }), 
    ...
    RC = Window:AddTab({ Title = "RaceV4 +Migare", Icon = "" }),
...
local Toggle = Tabs.RC:AddToggle("MyToggle", {Title = "Kill Player Trial", Default = false })
